...
public class ParentTypeComparator implements Comparator<Entry<IMethodDescription, Score>> {

	@Override
	public int compare(Entry<IMethodDescription, Score> o1, Entry<IMethodDescription, Score> o2) {
		return o1.getKey().getId().getParentType().compareToIgnoreCase(o2.getKey().getId().getParentType());
	}
