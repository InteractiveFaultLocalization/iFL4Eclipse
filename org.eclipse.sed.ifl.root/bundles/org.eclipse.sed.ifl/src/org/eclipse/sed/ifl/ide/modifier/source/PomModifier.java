...
public class PomModifier {
	...
	private String excludeLine;

	public void parsePOM(String POMPath) throws IOException, XmlPullParserException {
	...
	public void editSurefireConfig(String agentFilePath, String includePath, String excludePath, String listener)  {
		...
		for(int i=0;i<pList.size();i++) {
	        ...
	        Xpp3Dom value = new Xpp3Dom("value");
			  ...
			  argline.setValue("-javaagent:"+ agentFilePath + "=includes=" + includePath + ",excludes=" + excludePath);
